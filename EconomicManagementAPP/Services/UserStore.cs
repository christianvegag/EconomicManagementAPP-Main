...
namespace EconomicManagementAPP.Services
{
    public class UserStore : IUserStore<User>, IUserEmailStore<User>, IUserPasswordStore<User>
    {
        ...
        {
            user.Id = await repositorieUsers.Create(user);
        ...
        {
            return await repositorieUsers.FindUserByEmail(normalizedEmail);
        }
        ...
        {
            return await repositorieUsers.FindUserByEmail(normalizedUserName);
        }
